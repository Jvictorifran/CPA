...
export default function Footer() {
  ...
  return (
    <footer id="contato" className="bg-cpa-900 text-white">
      {/* CTA Strip */}
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8 py-12">
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div>
            <Image
              ...
              loading="eager"
            />
            <p className="mt-4 text-sm text-cpa-300 leading-relaxed max-w-xs">
          ...
          {/* Contact info */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-cpa-200 mb-4">
              Contato
            </h3>
            <ul className="space-y-3 text-sm text-cpa-300">
              <li className="flex items-center gap-2">
                <svg className="h-4 w-4 text-cpa-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                </svg>
                <a href="mailto:contato@cpa-agro.com.br" className="hover:text-white transition-colors">
                  contato@cpa-agro.com.br
                </a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="h-4 w-4 text-cpa-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <a href="tel:+556734228119" className="hover:text-white transition-colors">
                  (67) 3422-8119
                </a>
              </li>
              <li className="flex items-center gap-2">
        ...
        {/* Bottom bar */}
        <div className="mt-12 border-t border-cpa-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-cpa-400">
            © {currentYear} CPA — Consultoria e Planejamento em Agronegócio. Todos os direitos reservados.
          </p>
          <div className="flex gap-6 text-sm text-cpa-400">
            <button
              onClick={(e) => {
                e.preventDefault();
                window.dispatchEvent(new CustomEvent("open-legal-modal", { detail: { type: "privacidade" } }));
              }}
            ...
            <button
              onClick={(e) => {
                e.preventDefault();
                window.dispatchEvent(new CustomEvent("open-legal-modal", { detail: { type: "termos" } }));
              }}
              className="hover:text-white transition-colors"
            >
              Termos de Uso
